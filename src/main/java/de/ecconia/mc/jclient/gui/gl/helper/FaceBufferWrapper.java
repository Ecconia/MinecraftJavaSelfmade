...
public class FaceBufferWrapper implements Deleteable
{
	...
	public FaceBufferWrapper(GL3 gl, float[] data, int[] indices)
	{
		...
		//Tex vector: - - - <r> <g> <b>
		gl.glVertexAttribPointer(2, 2, GL3.GL_FLOAT, false, 9 * Float.BYTES, 7 * Float.BYTES);
